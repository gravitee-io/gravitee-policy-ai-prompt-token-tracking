...
class AiTokenTrackingConfigurationTest {
    ...
    void testCalculatePricing() {
        AiTokenTrackingConfiguration sut = new AiTokenTrackingConfiguration(null, buildPricingConfiguration(2));
    ...
    private static PricingConfiguration buildPricingConfiguration(long factor) {
        return new PricingConfiguration((double) factor, 1.0, 1.0, (double) factor);
    }
}
